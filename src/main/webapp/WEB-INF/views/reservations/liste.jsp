    ...
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        <%@ include file="/WEB-INF/views/layout/header.jsp" %>
            ...
            <div class="page-header">
                <h1><i class="bi bi-calendar-check me-2"></i>Liste des Réservations</h1>
                <p class="subtitle">Toutes les réservations de salles</p>
            </div>
            ...
            <c:if test="${empty reservations}">
                <div class="alert alert-warning alert-custom">
                    ...
                    Aucune réservation trouvée. Veuillez en créer une.
                </div>
            </c:if>
                        ...
                        <table class="table table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th><i class="bi bi-door-open me-1"></i>Salle</th>
                            ...
                            <tbody>
                                <c:forEach var="reservation" items="${reservations}">
                                    <tr>
                                        ...
                                        <td style="color: var(--primary-light); font-weight: 600;">
                                            ${reservation.salle.nom}</td>
                                        <td style="color: #1f1f22;">${reservation.utilisateur.prenom}
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-sm btn-danger btn-space"
                                                title="Supprimer"
                                                onclick="showDeleteRes('${reservation.id}','${reservation.salle.nom}','${reservation.dateDebut}')">
                    ...
                    <div class="modal-content"
                        ...
                        <div class="modal-body text-center" style="padding: 1.5rem;">
                            ...
                            <p style="color: var(--text-secondary); font-size: 0.95rem;">
                                Supprimer la réservation pour<br><strong id="drInfo"
            ...
            <script>
                ...
                function showDeleteRes(id, salleName, date) {
                    document.getElementById('drInfo').textContent = salleName + ' — ' + date;
