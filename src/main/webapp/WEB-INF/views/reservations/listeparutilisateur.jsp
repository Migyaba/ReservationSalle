    ...
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        <%@ include file="/WEB-INF/views/layout/header.jsp" %>
            ...
            <div class="page-header">
                <h1><i class="bi bi-person-lines-fill me-2"></i>Réservations : ${utilisateur.prenom} ${utilisateur.nom}
                </h1>
                <p class="subtitle">Historique des réservations pour cet utilisateur</p>
            </div>

            <div class="action-bar">
                <a href="/utilisateurs" class="btn btn-secondary me-2">
            ...
            <c:if test="${empty reservations}">
                <div class="alert alert-info alert-custom">
                    ...
                    Aucune réservation trouvée pour <strong>${utilisateur.prenom} ${utilisateur.nom}</strong>.
                </div>
            </c:if>
